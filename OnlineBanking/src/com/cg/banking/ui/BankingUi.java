...
public class BankingUi {
	...
	private void reteriveQuaterly() throws IOException, SQLException {
		// TODO Auto-generated method stub
	...
	private void reteriveDaily() throws IOException, SQLException {
		...
		System.out.println("These are the  all the daily details");
	}
	private void createNewAcc() throws IOException, SQLException, ParseException {
		...
		if(service.validateName(acctype))
		{
		...
		if(service.validateBal(mobileno))
		{
		System.out.println("Enter Email :");
		String email=sc.next();
		if(service.validateBal(email))
		{
